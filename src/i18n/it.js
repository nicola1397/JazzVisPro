export default {
  ...
  'nav.functional-harmony':'Armonia Funzionale','nav.quiz':'Quiz',
  'label.tuning':'Accordatura','label.key':'Tonalità','label.scale':'Scala',
  'label.root':'Tonica',
  'label.choices':'Opzioni',
  ...
  'label.display-mode':'Modalità Display','opt.normal':'Normale','opt.highlight':'Highlight','opt.custom':'Personalizzato',
  'btn.export-json':'Esporta JSON','btn.import-json':'Importa JSON',
  'btn.clear-all-notes':'Cancella Note',
  'msg.caged-not-applicable': 'Non applicabile a questa scala',
  ...
  'quiz.title':'Questionari Interattivi',
  'quiz.subtitle':'Verifica le tue conoscenze di teoria e armonia jazz con quiz mirati.',
  'quiz.setup':'Configurazione Quiz',
  'quiz.categories':'Categorie',
  'quiz.difficulty':'Difficoltà',
  'quiz.start':'Inizia Quiz',
  'quiz.progress':'Domanda',
  'quiz.no-questions':'Nessuna domanda trovata per i criteri selezionati.',
  'quiz.show-results':'Vedi Risultati',
  'quiz.complete':'Quiz Completato!',
  'quiz.final-score':'Punteggio Finale',
  'quiz.restart':'Ricomincia',
  'quiz.cat.jazz_harmony':'Armonia Jazz',
  'quiz.cat.jazz_theory':'Teoria Jazz',
  'quiz.cat.general_theory':'Teoria Generale',
  'srs.title':'Sistema di Ripasso (SRS)',
  'srs.boxes':'Box di apprendimento',
  'srs.box1':'Da rifare','srs.box2':'Iniziale','srs.box3':'Familiare','srs.box4':'Buono','srs.box5':'Padroneggiato',
  'srs.modeNew':'Solo nuove','srs.modeReview':'Solo ripasso','srs.modeMixed':'Misto (consigliato)',
  'srs.due':'pendenti','srs.badge':'RIPASSO','srs.noReview':'Nessuna domanda da ripassare',
  'srs.statsCorrect':'corrette','srs.statsWrong':'sbagliate','srs.statsNew':'nuove','srs.statsReview':'ripasso',
  'imp.mode':'Improv Guide',
  'imp.helper':'Modalità improvvisazione: scala suggerita evidenziata, guide tones (3ª/7ª) marcate ad ogni cambio accordo.',
  'gt.speedTrainer':'Speed Trainer','gt.speedFrom':'Da BPM','gt.speedTo':'A BPM','gt.speedStep':'Incremento','gt.speedBars':'Battute per step',
  'gt.preset-down':'Battere',
  ...
  'tc.title':'Teoria Chitarra',
  'tc.subtitle':'Introduzione alle tecniche chitarristiche con esempi in tablatura.',
  'nav.teoria-chitarra':'Teoria Chitarra',
  'title.teoria-chitarra':'TEORIA CHITARRA',
  'th.guit1':'1. Come leggere le tablature','th.guit2':'2. Hammer-on',
  'th.guit3':'3. Pull-off','th.guit4':'4. Slide (Glissato)',
  'th.guit5':'5. Bend','th.guit6':'6. Vibrato',
  'th.guit7':'7. Palm Mute','th.guit8':'8. Alternate Picking',
  'th.guit9':'9. Armonici Naturali','th.guit10':'10. Pinch Harmonics',
  'th.guit11':'11. Tapping','th.guit12':'12. Tremolo Picking',
  'th.guit13':'13. Legato','th.guit14':'14. Sweep Picking',
  'th.guit15':'15. Note Smorzate (Muted)',
  ...
  'et.history':'Statistiche per tipo','et.history-empty':'Nessuno storico presente.','et.clear-history':'Cancella Storico',
  ...
  'label.tips':'SUGGERIMENTI',
  'label.pro-tip':'Consiglio',
  'label.sequence':'SEQUENZA',
  'label.lick-tools':'STRUMENTI LICK',
  'label.tap':'TAP',
  'label.tempo':'tempo',
  'label.feel':'PORTAMENTO',
  'label.engines':'STRUMENTI',
  'label.flip-switch':'attiva uno switch',
  'label.metronome':'Metronomo',
  'label.chord-synth':'Sint. Accordi',
  'label.walking-bass':'Basso',
  'label.drum-kit':'Batteria',
  'label.selector':'SELETTORE',
  'label.chord-info':'INFO ACCORDO',
  'label.loading-app':'Caricamento Applicazione...',
  'label.loading-library':'Caricamento libreria...',
  'label.no-voicings':'Nessuna diteggiatura disponibile',
  'label.guide':'Guida',
  'label.caged-shape':'Forma CAGED',
  'label.ext':'Estensioni',
  'label.view':'Vista',
  'label.info':'INFO',
  'label.shape':'Forma',
  'label.bars':'Battute',
